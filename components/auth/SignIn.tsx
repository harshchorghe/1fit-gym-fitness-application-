...
import { auth } from '@/lib/firebase';  // Adjust path if needed (e.g. '@/lib/firebase')
...
export default function SignInPage() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      // Optional: You can get ID token here if needed later
      // const token = await userCredential.user.getIdToken();

      // Success → redirect
      router.push('/home'); // Change to your dashboard route, e.g. '/dashboard' or '/profile'
  ...
  return (
    <div className="min-h-screen bg-black text-white overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-red-500/5 rounded-full blur-3xl animate-pulse-slow"></div>
      </div>
      ...
      <div className="relative z-10 min-h-screen flex items-center justify-center px-4 py-12">
        <div className="w-full max-w-md">
          ...
          <div className="text-center mb-8 animate-slide-in-up">
            ...
            <p className="text-gray-400 text-lg">Continue your transformation</p>
          </div>
          ...
          <div className="bg-gradient-to-b from-gray-900 to-black border-2 border-gray-800 p-6 sm:p-8 md:p-10 animate-slide-in-up stagger-2">
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-2">
                  <input
                    ...
                    onChange={handleChange}
                    className="w-5 h-5 bg-black/50 border-2 border-gray-800 focus:ring-0 focus:ring-offset-0 cursor-pointer accent-red-500"
                  />
              ...
              {/* Error Message */}
              {error && (
                <div className="bg-red-900/40 border border-red-600 text-red-200 px-4 py-3 rounded text-center text-sm">
                  {error}
                </div>
              )}
              ...
              {/* Social Sign In – placeholders (implement later if needed) */}
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <button
                  type="button"
                  className="flex items-center justify-center space-x-3 border-2 border-gray-800 hover:border-red-500 py-3 transition-all opacity-50 cursor-not-allowed"
                  disabled
                >
          ...
          {/* Quick Access Info */}
          <div className="mt-12 p-6 border border-gray-800 bg-gray-900/30 animate-slide-in-up stagger-4">
            <div className="flex items-start space-x-3">
              ...
              <div>
                <h3 className="font-bold text-white mb-2" style={{ fontFamily: 'Oswald, sans-serif' }}>
                  FIRST TIME HERE?
                </h3>
                <p className="text-sm text-gray-400 mb-3">
                  Sign up today and get your first week free. No credit card required.
                </p>
                <Link 
                  href="/signup" 
                  className="inline-block text-sm text-red-500 hover:underline font-semibold"
                >
